...
focusKeyphrase: CV de desarrollador
seoTitle: "CV de desarrollador: más que una lista de tecnologías"
seoDescription: "Cómo escribir un CV de desarrollador que cuente decisiones y resultados en vez de listar tecnologías, con ejemplos del antes y el después."
...
La primera versión es una lista de sustantivos. La segunda cuenta cómo pienso el trabajo. Eso es exactamente lo que un reclutador —o un cliente evaluando contratarme— no puede ver mirando solo el nombre de las tecnologías. Es también lo que los sistemas de seguimiento de candidatos [no filtran por palabra clave](https://www.smartrecruiters.com/resources/glossary/applicant-tracking-system-ats/), y donde una persona real sí se detiene a leer.
...
Contar eso requiere frases más largas que una lista de tecnologías. Pero es la única forma de que la combinación se note, en vez de leerse como dos habilidades genéricas puestas una al lado de la otra. Lo mismo aplica al [portafolio de proyectos](/es/blog/como-elijo-que-proyectos-entran-a-mi-portafolio).
