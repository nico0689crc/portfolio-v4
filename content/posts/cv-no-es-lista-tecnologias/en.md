---
slug: my-resume-stopped-being-a-list-of-technologies
title: "My résumé stopped being a list of technologies, and conversations changed"
excerpt: "React, Node, TypeScript — anyone can write that list. What I changed was telling what decision I made and what happened, not which tool I used to make it."
focusKeyphrase: developer resume
seoTitle: "Developer resume: more than a list of technologies"
seoDescription: "How to write a developer resume that tells decisions and outcomes instead of listing technologies, with before-and-after examples from my own."
ogTitle: "\"Worked with React and Node.js\" tells nobody anything"
...
The first version is a list of nouns. The second tells how I think about the work. That's exactly what a recruiter — or a client evaluating whether to hire me — can't see by looking only at the technology names. It's also what an [applicant tracking system](https://www.smartrecruiters.com/resources/glossary/applicant-tracking-system-ats/) doesn't filter by keyword, and where a real person does stop to read.
...
Telling that requires longer sentences than a list of technologies. But it's the only way the combination actually shows, instead of reading as two generic skills placed side by side. The same applies to [portfolio projects](/en/blog/how-i-choose-which-projects-go-in-my-portfolio).
