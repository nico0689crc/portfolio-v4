---
slug: el-primer-minuto-que-decide-si-alguien-vuelve
...
Un tutorial explica funcionalidad. Un onboarding bien diseñado demuestra valor. Son objetivos distintos, y la mayoría de los productos diseñan el primero pensando que están haciendo el segundo.
...
## El caso donde esto se aplica en la práctica

Cuando diseñé el flujo de un socio nuevo en GymSmartAccess, el camino no empieza con una explicación del sistema de QR. Empieza con el socio recibiendo el link de pago —ya con su nombre y el monto correcto— y viendo confirmado que puede entrar al gimnasio inmediatamente después de pagar. Todo el aprendizaje sobre cómo funciona el QR, dónde ver su historial de pagos, cómo contactar al gimnasio, viene después. Primero la prueba de que el sistema resuelve lo que tiene que resolver.
...
Un onboarding no existe para que la persona sepa usar el producto. Existe para que la persona decida que quiere aprender a usarlo. Esa decisión se toma en el primer minuto, o no se toma nunca, y ningún tutorial completo la compensa si ese primer minuto no demostró nada.
