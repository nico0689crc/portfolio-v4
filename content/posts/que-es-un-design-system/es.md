...
seoTitle: "Qué es un design system: definición real y cuándo no lo necesitás"
seoDescription: "Qué es exactamente un design system, en qué se diferencia de una librería de componentes, y las señales que indican si tu proyecto lo necesita o si es sobre-ingeniería."
...
Un design system es la combinación de tres cosas: [tokens](/es/blog/design-tokens-figma-a-tailwind) (los valores nombrados: color, espaciado, tipografía), componentes (las piezas construidas con esos tokens: botones, tarjetas, inputs) y reglas de uso (cuándo usar cada componente y cuándo no).
