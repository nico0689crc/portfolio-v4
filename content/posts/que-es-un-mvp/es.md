...
**No es un prototipo.** Un prototipo se mira, un MVP se usa. El prototipo de Figma que hice para [el rediseño de Mexx](/es/proyectos/rediseno-ux-ui-ecommerce-mexx) navega y parece real, pero no procesa una compra. Sirve para validar si la gente entiende una interfaz. No sirve para saber si alguien paga.
...
Si querés ver cómo se decide ese recorte en concreto, lo escribí en [de idea a MVP](/es/blog/de-idea-a-mvp-que-construir).
