---
slug: ux-personas-with-real-data
...
UX personas have a bad reputation, and it's a deserved one. Most are a made-up name, a stock-photo smile, and three demographic facts that change no design decision. They get made, printed, pinned to a wall, and never looked at again.

The problem isn't the tool. It's that it's almost always built backwards.

## The question that decides whether it's useful

Before building a persona, I ask myself: **what design decision is this going to change?**
...
After building Lucas and Sofía, I went back to the feature list we were about to prioritize. Cart recovery via magic link — which was in the middle of the list — moved up in priority because it's exactly what Sofía needs: getting back to a cart she built on another device without having to search for the product again.

That's the moment that separates a useful persona from a decorative one: when it changes the order of a list, not when it looks nice on a slide.

## What I leave out on purpose

I don't add a full name, a hometown, or made-up hobbies. Every extra fact that didn't come from real evidence is an opportunity for someone on the team to design for the invented detail instead of the real pattern. If Lucas "lives in Palermo and likes mate", that sentence helps decide nothing — it just makes the persona feel more real without being so.

Fewer decorative details make it easier to see which ones matter.
