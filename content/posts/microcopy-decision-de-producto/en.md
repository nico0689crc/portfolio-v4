...
seoDescription: "Why the text in buttons, errors and empty states can't be the last thing written in a project, with concrete examples of decisions and their impact."
...
There's a quick test for whether a team treats microcopy as a product decision or as last-minute filler: check who writes the error messages. If the answer is "whoever was coding that screen, in a hurry, five minutes before deploying to production", you already know the result: "Something went wrong. Please try again."
...
It's the same logic I apply to the rest of the interface: nothing counts as finished until it can be used without anyone having to guess.
