...
// Type Imports
import type { MenuGroupSubItem, MenuItem, MenuLeafSubItem, MenuSubItem, NavItem } from '@/components/admin/config/navConfig'

// Component Imports
import LogoSvg from '@/components/admin/assets/logo'
...
// Config Imports
import { navItems } from '@/components/admin/config/navConfig'
          ...
          <SidebarMenuItem>
            ...
            >
              ...
              <div className='flex flex-col items-start'>
                ...
                <span className='text-xs font-light text-nowrap'>Panel de contenido</span>
              </div>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
